...
function AnaliseAcoesCalculaPorcentagemCrescimentoCotacoes({ result }) {
    ...
    return (
        <Layout title="Quantitative System">
            <h1>Análise Ações - Calculo Porcentagem Crescimento</h1>
...
export default AnaliseAcoesCalculaPorcentagemCrescimentoCotacoes;


export async function getStaticProps(context) {
    const res = await fetch(ACAO_ANALISE_URL + '/sum-increase-percent-cotacao')
