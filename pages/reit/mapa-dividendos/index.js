...
import { REIT_URL, ATIVOS_ANALISE_URL, REIT_ANALISE_URL } from '../../../constants/constants';
...
function MapaDividendosReits() {
    ...
    const handleSubmit = async () => {
        const res = await fetch(REIT_URL + '/mapa-dividendos/' + periodoInicio + '/' + periodoFim)
    ...
    const handleAddAtivoAnalise = async (sigla) => {
        ...
        alert('reit adicionada na lista de Ativos sendo analisados: ' + sigla) 
    }
    ...
    const handleAddAnalise = async (sigla) => {
        ...
        const data = await response.json()           
        alert('reit adicionada na lista de analises: ' + sigla) 
    }
...
export default MapaDividendosReits;