...
function AnaliseReitsCalculaPorcentagemCrescimentoCotacoes({ result }) {
    ...
    return (
        <Layout title="Quantitative System">
            <h1>Análise Reits - Calculo Porcentagem Crescimento</h1>
...
export default AnaliseReitsCalculaPorcentagemCrescimentoCotacoes;


export async function getStaticProps(context) {
    const res = await fetch(REIT_ANALISE_URL + '/sum-increase-percent-cotacao')
