...
function MapaDividendosStocks() {
    ...
    const handleSubmit = async () => {
        const res = await fetch(STOCK_URL + '/mapa-dividendos/' + periodoInicio + '/' + periodoFim)
    ...
    const handleAddAtivoAnalise = async (sigla) => {
        ...
        const response = await fetch(ATIVOS_ANALISE_URL + '/add-analise-ativo/stock/' + sigla, {
            method: 'POST',
            body: JSON.stringify(
                {                
        ...
        alert('Stock adicionada na lista de Ativos sendo analisados: ' + sigla) 
    }

    const handleAddAnalise = async (sigla) => {

        const response = await fetch(STOCK_ANALISE_URL + '/add-stock/' + sigla, {
            method: 'POST',
            body: JSON.stringify(
                {                
        ...
        const data = await response.json()           
        alert('Stock adicionada na lista de analises: ' + sigla) 
    }
...
export default MapaDividendosStocks;