...
import { STOCK_SIMULACAO_INVESTIMENTO_URL } from '../../../../constants/constants'
...
function AddSimularInvestimentoDetail() {
    ...
    const handleSubmit = async () => {    
        ...
        const response = await fetch(STOCK_SIMULACAO_INVESTIMENTO_URL + '/save-simulacao-detail-investimento', {
            method: 'POST',
            body: JSON.stringify(
                {                
                    sigla: sigla,
    ...
    return (
        <Layout>
              <h1>Adição de Simulação de Detalhe Investimento Várias Stocks</h1>
