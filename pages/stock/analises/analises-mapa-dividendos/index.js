...
function MapaDividendosAnaliseAcoes() {
    ...
    const handleSubmit = async () => {
        const res = await fetch(STOCK_ANALISE_URL + '/mapa-dividendos/' + periodoInicio + '/' + periodoFim)
    ...
    return (
        <Layout title="Quantitative System">
            <h1>Análise Stocks - Mapa Dividendos</h1>
...
export default MapaDividendosAnaliseAcoes;