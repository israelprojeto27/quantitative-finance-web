...
function AnaliseStocksCalculaPorcentagemCrescimentoCotacoes({ result }) {
    ...
    return (
        <Layout title="Quantitative System">
            <h1>Análise Stocks - Calculo Porcentagem Crescimento</h1>
...
export default AnaliseStocksCalculaPorcentagemCrescimentoCotacoes;


export async function getStaticProps(context) {
    const res = await fetch(STOCK_ANALISE_URL + '/sum-increase-percent-cotacao')
