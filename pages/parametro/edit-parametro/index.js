...
function EditParametro({ router: { query } }) {
    ...
    useEffect(() => {
        setId(object.id);                
        setTipoParametro(object.tipoParametro);      
        setTipoValorParametro(object.tipoValorParametro);                   
        setValorParametro(object.valor);                   
        setObs(object.obs);                   
    }, []);
        ...
        <Layout title="Quantitative System">
            ...
            <Box
                ...
                <div className={classes.buttonAdd}>
                    <Button variant="contained" fullWidth="true" onClick={handleSubmit}>Atualizar</Button>
                </div>
...
export default withRouter(EditParametro);
