...
function MapaDividendosAnaliseBdrs() {
    ...
    const handleSubmit = async () => {
        const res = await fetch(BDR_ANALISE_URL + '/mapa-dividendos/' + periodoInicio + '/' + periodoFim)
    ...
    return (
        <Layout title="Quantitative System">
            <h1>Análise BDRs - Mapa Dividendos</h1>
...
export default MapaDividendosAnaliseBdrs;