...
function AnaliseBdrCalculaPorcentagemCrescimentoCotacoes({ result }) {
    ...
    return (
        <Layout title="Quantitative System">
            <h1>Análise BDRs - Calculo Porcentagem Crescimento</h1>
...
export default AnaliseBdrCalculaPorcentagemCrescimentoCotacoes;


export async function getStaticProps(context) {
    const res = await fetch(BDR_ANALISE_URL + '/sum-increase-percent-cotacao')
