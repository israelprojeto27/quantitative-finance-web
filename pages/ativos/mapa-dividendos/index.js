...
function AtivosMapaDividendos() {
    ...
    const handleSubmit = async () => {
        const res = await fetch(ATIVOS_URL + '/mapa-dividendos/' + periodoInicio + '/' + periodoFim)
...
export default AtivosMapaDividendos;