...
function AnaliseAtivosCalculaPorcentagemCrescimentoCotacoes({ result }) {
    ...
    return (
        <Layout title="Quantitative System">
            <h1>Análise Ativos - Calculo Porcentagem Crescimento</h1>
...
export default AnaliseAtivosCalculaPorcentagemCrescimentoCotacoes;


export async function getStaticProps(context) {
    const res = await fetch(ATIVOS_ANALISE_URL + '/sum-increase-percent-cotacao')
