...
function AnaliseAtivosMapaDividendos() {
    ...
    const handleSubmit = async () => {
        const res = await fetch(ATIVOS_ANALISE_URL + '/mapa-dividendos/' + periodoInicio + '/' + periodoFim)
    ...
    return (
        <Layout title="Quantitative System">
            <h1>Análise Ativos - Mapa Dividendos</h1>
...
export default AnaliseAtivosMapaDividendos;