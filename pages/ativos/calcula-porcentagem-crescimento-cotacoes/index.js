...
function AtivosCalculaPorcentagemCrescimentoCotacoes({ result }) {
    ...
    return (
        <Layout title="Quantitative System">
            <h1>Ativos - Calculo Porcentagem Crescimento</h1>
...
export default AtivosCalculaPorcentagemCrescimentoCotacoes;


export async function getStaticProps(context) {
    const res = await fetch(ATIVOS_URL + '/sum-increase-percent-cotacao')
