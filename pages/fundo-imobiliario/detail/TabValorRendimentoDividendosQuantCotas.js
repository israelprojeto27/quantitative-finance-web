...
import { FUNDO_IMOBILIARIO_DIVIDENDO_URL } from '../../../constants/constants'
...
function TabValorRendimentoDividendosQuantCotas({ativo}) {
    ...
    const handleSubmit = async () => {
        ...
        const res = await fetch(FUNDO_IMOBILIARIO_DIVIDENDO_URL + '/simula-rendimento-dividendo-by-sigla-by-cotas/' + searchPapel + '/' + quantidadeCotas)
